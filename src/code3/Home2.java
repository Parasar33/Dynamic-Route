...
public class Home2 extends JFrame {
    ...
    private static JTextArea timeTextArea; // Make this static
    ...
    public Home2() {
        ...
        timeTextArea = new JTextArea(); // Change this to static
        ...
        startSimulation.addActionListener(e -> {
            mapPanel.startRideSharingSimulation(); // Call the method in PathFinder
            timeTextArea.setText("Simulation with GA in progress...");
        });
    ...
    public static void updateTimeText(String message) {
        timeTextArea.setText(message); // Update the time text area
    }
